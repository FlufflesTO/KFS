...
export async function getClientDashboardData(siteIds: string[]): Promise<ClientDashboardData> {
  ...
  // Execute all queries in parallel for better performance using db.batch
  // This reduces multiple HTTP roundtrips to the Cloudflare D1 API into a single roundtrip.
