...
import { cleanDate, cleanId, cleanText, cleanChoice, readJson, requireAdmin } from "../../../../lib/server/admin.js";
...
export async function POST({ request, locals }) {
  ...
  try {
    ...
    await auditError(typeof db !== "undefined" ? db : context.locals.db, typeof request !== "undefined" ? request : context.request, error, { user: typeof user !== "undefined" ? user : context.locals.user, metadata: { message: "admin certificates failed" } });
