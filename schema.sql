...
-- Offline mutation idempotency ledger (from 0032_offline_mutations.sql)
...
-- User profiles table (from 0035_user_profiles_staff_hr.sql)
...
-- Staff HR leave balances table (from 0035_user_profiles_staff_hr.sql)
...
-- Staff HR document vault table (from 0035_user_profiles_staff_hr.sql)
...
-- Staff HR leave requests table (from 0035_user_profiles_staff_hr.sql)
CREATE TABLE IF NOT EXISTS staff_leave_requests (
    ...
    supporting_document_id TEXT REFERENCES staff_documents(id) ON DELETE SET NULL,
