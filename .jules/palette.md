...
## 2026-09-23 - Focus Rings on Summary Elements
...
**Action:** Add `focus-visible` utility classes to all interactive native elements that have their default appearance modified.
